...
notas de um aluno. Calcule a média com pesos 2, 3, 4 e 1, respectivamente, 
...
As mensagens devem ser impressas conforme a descrição do problema. Não esqueça 
...
if media >= 7.0:
    ...
    if media_final >= 5.0:
        print(f"Aluno aprovado. A Media final do aluno: {media_final:.1f}")
    else:
        print("Aluno reprovado. A Media final do aluno: {media_final:.1f}")
