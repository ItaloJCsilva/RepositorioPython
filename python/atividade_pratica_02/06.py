...
o valor que recebe por hora. Calcule o salário do funcionário e 
...
Saída:
Imprima o número do funcionário e o 
salário calculado com duas casas decimais. 
Deve haver um espaço em branco antes e depois do 
sinal de igualdade, e no caso do salário, também um espaço em branco após o R$'''
...
print(f"Numero do funcionario = {numero_funcionario}")
print(f"Salario do funcionario = R$ {salario:.2f}")
